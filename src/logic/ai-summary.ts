...
export async function generateClinicalSummary(
  ...
  const aiAugmentedLabel = "\n\n---\n**AI-Augmented Insight** (Confidence: 75%)\n*This summary is generated by Gemini 1.5 Flash based on FDA labeling.*";
  
  return (text || fallbackSummary(drugTitle, rawData)) + aiAugmentedLabel;
}
